...
extern enum ResCodes initializeWorm(int len_max,int headpos_y, int headpos_x, enum WormHeading dir, enum ColorPairs color) {
  ...
  theworm_wormpos_x [theworm_headindex]  = /*@008*/headpos_x;//Globale variablen zentral zu bestücken

  // Initialize the heading of the worm
  /* @009*/ setWormHeading (dir);
...
extern void showWorm() {
  ...
  placeItem(
      ...
      /* @007,*/ theworm_wormpos_x[theworm_headindex],
      SYMBOL_WORM_INNER_ELEMENT,theworm_wcolor);//dieser aufruf können wir ersetzten dirch showworm kapseln viel code in wenig code
}
...
extern void moveWorm(enum GameStates* agame_state) {
  ...
  int headpos_x =  theworm_wormpos_x[theworm_headindex]  + /*@010*/theworm_dx;//bewegt wurm einfach um die delta werte
